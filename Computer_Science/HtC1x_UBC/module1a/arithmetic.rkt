...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname arithmetic_expressions) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

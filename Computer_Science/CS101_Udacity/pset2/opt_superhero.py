...
## Returns product, if all its characters are found on debris, else "Give me something that's not useless next time."
## def fix_machine(debris, product): return "-"                 #stub

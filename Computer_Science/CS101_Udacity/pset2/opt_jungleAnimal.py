...
## String Number -> _NOTHING_
# def jungle_animal(animal, my_speed): print("")                    #stub
def jungle_animal(animal, my_speed):
    if animal == "cheetah":
        cheetahSpeed = 115;
        if my_speed <= cheetahSpeed: print("Stay calm and wait!")
        else: print("Run!")
    elif animal == "zebra": print ("Try to ride a zebra!")
